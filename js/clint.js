function clintPrimeiraFase (){
    ...
    promptEscolha(msg, 'arvoregameover.html', 'interiormasmorra.html');
}
...
function clintSegundaFase (){
    ...
    2. Direita. 
    `;
    promptEscolha(msg, 'esquerdagameover.html', 'corredormasmorra.html');
}
...
function clintTerceiraFase (){
    ...
    `;
    promptEscolha(msg, 'hackearportagameover.html', 'vitoria.html');
}